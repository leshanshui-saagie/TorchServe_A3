...
class ELDATopicClassifier(object):
    """
    """
    def __init__(self):
        self.model = None
    ...
    def initialize(self, ctx):
        ...
        model_pt_path = os.path.join(model_dir, "topic_model.pt")
    ...
    def postprocess(self, predictions):
        classes = {0: 'Joueur de foot',
                     1: 'Club_Football',
                     2: 'Match de foot',
                     3: 'Sport',
                     4: 'Supporters',
                     5: 'Racisme',
                     6: 'Personnalité Politique',
                     7: 'Islamophobie',
                     8: 'Attentats',
                     9: 'Préjugés'}
